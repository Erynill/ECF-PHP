...
(!(function (e, t) {
            ...
            (function (e, t, n, o) {
              ...
              (z([e, t, n], r.styled),
                o.confirmButtonColor &&
                  e.style.setProperty("--swal2-confirm-button-background-color", o.confirmButtonColor));
  ...
  const ge = ["input", "file", "range", "select", "radio", "checkbox", "textarea"],
    ...
    Ae = (e, t) => {
      ["string", "number"].includes(typeof t)
        ? (e.value = `${t}`)
        : b(t) || u(`Unexpected type of inputValue! Expected "string", "number" or "Promise", got "${typeof t}"`);
    },
    Ee = {};
  ((Ee.text =
    Ee.email =
  ...
  const He = (e) => {
    ...
    Ie = (e) => {
      ...
      if (t && Te) {
        ...
        const s = n - Se;
        ((t.style.insetInlineStart = `${Me + (o.isRTL ? -s : s)}px`), (t.style.insetBlockStart = `${je + (i - Oe)}px`));
      }
    },
    De = () => {
      const e = C();
      ...
      (qe(0, t),
        ...
        ((e, t) => {
          ...
          if (t.icon && -1 === Object.keys(a).indexOf(t.icon))
            return (
              d(`Unknown icon! Expected "success", "error", "warning", "info" or "question", got "${t.icon}"`),
              void Z(o)
            );
          (X(o),
            Le(o, t),
        ...
        "object" != typeof e[0] || fn(e[0])
          ? ["title", "html", "icon"].forEach((n, o) => {
              ...
              "string" == typeof i || fn(i)
                ? (t[n] = i)
                : void 0 !== i && d(`Unexpected type of ${n}! Expected "string" or "Element", got ${typeof i}`);
            })
          : Object.assign(t, e[0]),
        t
      );
      ...
      return (
        Array.from(e.querySelectorAll("swal-button")).forEach((e) => {
          ...
          if (n && ["confirm", "cancel", "deny"].includes(n)) {
            if (((t[`${n}ButtonText`] = e.innerHTML), (t[`show${c(n)}Button`] = !0), e.hasAttribute("color"))) {
  ...
  class Un {
    constructor(...t) {
      if (
        (n(this, Fn, Promise.resolve({ isConfirmed: !1, isDenied: !1, isDismissed: !0 })), "undefined" == typeof window)
      )
        return;
      Rn = this;
